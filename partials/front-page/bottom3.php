<div class="main-box lg:py-32 py-10 bg-no-repeat bg-cover bg-center" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/front-page/bottom3-img1.jpg');">
    <div class="wrapper">
