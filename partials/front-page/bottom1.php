...
<div class="main-box lg:py-32 py-10 bg-grey">
    <div class="wrapper">
        <div class="w-full text-center">
            <span class="text-label-2">Watch and listen</span>
            <h2 class="lg:text-h2 md:text-h4 text-h5 lg:mt-5  uppercase">The benefits of <span class="block">joining our church</span></h2>
        </div>
