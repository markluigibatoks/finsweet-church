<div class="main-box lg:py-32 py-10">
    <div class="wrapper">
        <div class="w-full text-center">
            ...
            <h2 class="lg:mt-4 lg:text-h2 md:text-h4 text-h5 uppercase">SHARE, INSPIRE, INNOVATE</h2>
        </div>

        <div class="lg:mt-16 mt-10 grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          <div class="px-8 pt-12 pb-8 border-b-16 border-primary bg-light-orange w-full text-center lg:text-left">
            ...
            <span class="mt-12 block text-label-3">By Mathew Johnson</span>
